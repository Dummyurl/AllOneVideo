    ...
    private class MyTask extends AsyncTask<String, Void, String> {
        ...
        public void setAdapterToListview() {
            ...
            if (video_type.equals("local")) {
                Picasso.get().load(video_thumbnail_b).placeholder(R.drawable.placeholder).into(vp_imageview);
            }else if (video_type.equals("server_url")) {
                Picasso.get().load(video_thumbnail_b).placeholder(R.drawable.placeholder).into(vp_imageview);
            } else if (video_type.equals("youtube")) {
                Picasso.get().load(Constant.YOUTUBE_IMAGE_FRONT + video_playid + Constant.YOUTUBE_SMALL_IMAGE_BACK).placeholder(R.drawable.placeholder).into(vp_imageview);
            } else if (video_type.equals("dailymotion")) {
                Picasso.get().load(Constant.DAILYMOTION_IMAGE_PATH + video_playid).placeholder(R.drawable.placeholder).into(vp_imageview);
